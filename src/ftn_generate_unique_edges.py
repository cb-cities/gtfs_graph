...
def generate_unique_edges(path):
	...
	print "Sorting results list by service_id"
	...
	for i in xrange(0, len(results), chunkSize):
		with gzip.open('../out/unique_edges/unique_edge_' + str((i//chunkSize)+1) + '.json.gz', 'w') as outfile:
